...
<p><strong>[이미지 3]</strong><br>
<strong>alt 태그:</strong> A veterinarian reviewing a full-day glucose curve with a pet parent and dog<br>
<strong>이미지 프롬프트:</strong> Hyper-realistic 3D render style, photorealistic appearance. Inside a modern veterinary consultation room, a veterinarian reviews a simple full-day glucose curve on a tablet together with a pet parent while a dog rests comfortably nearby. The chart has no readable dosage numbers. Realistic clinical lighting, natural expressions, trustworthy educational atmosphere.</p>
...
<p><strong>[이미지 1]</strong><br>
<strong>alt 태그:</strong> 한국 아파트에서 당뇨 강아지의 식사와 물 섭취를 기록하는 보호자 옆에서 관찰하는 안심이<br>
<strong>이미지 프롬프트:</strong> Hyper-realistic 3D render style, photorealistic appearance. A brown dachshund wearing round-rimmed glasses and holding a small gold magnifying glass looks as if he is wearing a white lab coat. He is a researcher, and his name is Ansim. He is gently observing a diabetic dog beside its meal bowl while a Korean pet parent records appetite, water intake, and daily routine in a notebook in a cozy Korean apartment living room. Realistic fur, natural daylight, warm trustworthy veterinary research atmosphere, no dosage numbers, no injection close-up, educational composition.</p>
...
<p><strong>[이미지 2]</strong><br>
<strong>alt 태그:</strong> 강아지의 식사량과 음수량 소변 체중 활동량을 생활기록에 적는 보호자<br>
<strong>이미지 프롬프트:</strong> Hyper-realistic 3D render style, photorealistic appearance. A Korean pet parent calmly records a dog's meals, water intake, urination pattern, body weight, and activity in a simple daily diabetes log at home. The dog rests comfortably nearby. Natural daylight, realistic fur and home textures, educational and reassuring mood, no medication dosage text.</p>
...
<p><strong>[이미지 3]</strong><br>
<strong>alt 태그:</strong> 동물병원에서 강아지 혈당곡선을 보호자와 함께 확인하는 수의사<br>
<strong>이미지 프롬프트:</strong> Hyper-realistic 3D render style, photorealistic appearance. Inside a modern veterinary consultation room, a veterinarian reviews a simple full-day glucose curve on a tablet together with a pet parent while a dog rests comfortably nearby. The chart has no readable dosage numbers. Realistic clinical lighting, natural expressions, trustworthy educational atmosphere.</p>
...
<p><strong>[이미지 1]</strong><br>
<strong>alt 태그:</strong> 韓国のアパートで糖尿病の犬の食事と飲水を記録する飼い主を見守るアンシミ<br>
<strong>이미지 프롬프트:</strong> Hyper-realistic 3D render style, photorealistic appearance. A brown dachshund wearing round-rimmed glasses and holding a small gold magnifying glass looks as if he is wearing a white lab coat. He is a researcher, and his name is Ansim. He is gently observing a diabetic dog beside its meal bowl while a Korean pet parent records appetite, water intake, and daily routine in a notebook in a cozy Korean apartment living room. Realistic fur, natural daylight, warm trustworthy veterinary research atmosphere, no dosage numbers, no injection close-up, educational composition.</p>
...
<p><strong>[이미지 2]</strong><br>
<strong>alt 태그:</strong> 犬の食事量・飲水・排尿・体重・活動を生活記録に残す飼い主<br>
<strong>이미지 프롬프트:</strong> Hyper-realistic 3D render style, photorealistic appearance. A Korean pet parent calmly records a dog's meals, water intake, urination pattern, body weight, and activity in a simple daily diabetes log at home. The dog rests comfortably nearby. Natural daylight, realistic fur and home textures, educational and reassuring mood, no medication dosage text.</p>
...
<p><strong>[이미지 3]</strong><br>
<strong>alt 태그:</strong> 動物病院で犬の血糖曲線を飼い主と一緒に確認する獣医師<br>
<strong>이미지 프롬프트:</strong> Hyper-realistic 3D render style, photorealistic appearance. Inside a modern veterinary consultation room, a veterinarian reviews a simple full-day glucose curve on a tablet together with a pet parent while a dog rests comfortably nearby. The chart has no readable dosage numbers. Realistic clinical lighting, natural expressions, trustworthy educational atmosphere.</p>
...
<h2>9. 糖尿病管理で「完璧な1日」より大切なこと</h2>
<p>毎日正確に同じ1日を作ることが目標ではありません。</p>
<p>大切なのは、普段のパターンを知り、変化に気づくことです。</p>

<h2>10. 糖尿病の再診時に持参すると役立つこと</h2>
<p>単一の血糖値だけでなく、食欲、飲水量、排尿、体重の変化、行動記録を持参してください。</p>

<h2>11. アンシミの研究ノート</h2>
<p>犬の糖尿病はひとつのタイムスケジュールや血糖値で管理するものではありません。食事、インスリン、水、尿、体重、活動がひとつの物語を作ります。</p>`
  }
];
...
async function run() {
  ...
  for (const item of postsData) {
    ...
    console.log(`✅ WP Post ID ${updatedPost.id} successfully updated with CLEAN references section!`);
  ...
  console.log('🎉 REFERENCES UI FIX COMPLETE FOR BATCH 001 - 003!');
}
