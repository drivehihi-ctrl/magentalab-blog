  ...
  return (
    <div className="bg-slate-50 pb-20">
      ...
      <SeoArticle title="강아지와 고양이 중독(Toxicity), 빠른 대처가 중요합니다">
        ...
        <p>
          <strong>가정에서 임의로 구토를 유도하지 말고 수의사의 지시를 받으세요.</strong> 임의로 소금물이나 과산화수소 등을 먹여 구토를 유발하는 것은 위장관 손상이나 흡인성 폐렴 등의 합병증을 일으킬 수 있어 매우 위험합니다. 반드시 수의사의 구체적인 지시를 받은 경우에만 시행해야 합니다.
        </p>
