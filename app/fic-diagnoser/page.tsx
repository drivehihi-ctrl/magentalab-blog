  ...
  return (
    <div className="bg-slate-50 pb-20">
      ...
      <SeoArticle title="고양이에게 흔한 하부요로질환, 특발성 방광염(FIC)이란?">
        <p>
          고양이 하부요로질환(FLUTD, Feline Lower Urinary Tract Disease)은 하나의 특정 질병을 뜻하는 것이 아니라 방광과 요도에 발생하는 여러 질환을 통칭하는 표현입니다. 그중 <strong></strong>은 특히 흔하게 진단되는 원인 중 하나이며, 여러 연구에서 FLUTD 증상을 보이는 고양이의 약 55~65% 내외를 차지하는 것으로 보고되고 있습니다.
        </p>
        <p>
        ...
        <p>
          FIC의 정확한 원인은 아직 하나로 밝혀지지 않았습니다. 다만 현재 수의학에서는 <strong></strong>으로 이해하고 있습니다.
        </p>
        <p>
          고양이는 생활환경의 변화와 사회적 긴장에 민감할 수 있습니다. 이사, 새로운 가족이나 반려동물의 등장, 다른 고양이와의 갈등, 생활패턴 변화, 화장실 환경의 변화 등은 일부 고양이에서 스트레스 요인이 될 수 있습니다.
        </p>
        <p>
          하지만 단순히 “스트레스를 받으면 방광염이 생긴다”는 의미는 아닙니다. 모든 스트레스가 FIC를 일으키는 것도 아니며, 고양이마다 스트레스에 대한 반응과 질환 발생 위험에는 차이가 있습니다. 다만 FIC가 반복되는 고양이에서는 생활환경을 안정시키고 스트레스 요인을 줄이는 <strong></strong>이 관리의 중요한 요소가 될 수 있습니다.
        </p>
        ...
        <p>
          수컷 고양이는 암컷보다 요도가 길고 좁기 때문에 <strong></strong>의 위험이 더 높습니다. FIC에 따른 염증이나 요도 경련, 요도 플러그, 결석 등이 요도를 막으면 소변이 정상적으로 배출되지 않을 수 있습니다.
        </p>
        <p>
          고양이가 화장실을 계속 들락거리며 힘을 주는데 <strong></strong>
        </p>
        <p>
          완전한 요도폐색이 지속되면 신장 기능에 심각한 영향을 주고 혈중 칼륨 증가와 산-염기 이상, 요독증 등 생명을 위협하는 합병증으로 이어질 수 있습니다. 따라서 특히 수컷 고양이가 반복적으로 배뇨 자세를 취하지만 실제 소변이 나오지 않는다면 <strong></strong>
        </p>
        <p>
