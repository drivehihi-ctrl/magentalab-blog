  ...
  return (
    <div className="bg-slate-50 pb-20">
      ...
      <SeoArticle title="강아지와 고양이, 평생 양육비는 얼마나 들까요?">
        <p>
          반려동물을 가족으로 맞이하기 전에는 사랑과 관심뿐 아니라 **끝까지 돌볼 수 있는 경제적인 준비가 되어 있는지**도 함께 생각해야 합니다. 사료와 간식 같은 식비부터 위생용품, 예방접종과 건강검진, 미용, 질병 치료까지 반려동물을 돌보는 데에는 꾸준한 비용이 발생하기 때문입니다.
        </p>
        <p>
          농림축산식품부가 발표한 **2025년 동물복지 국민의식조사**에 따르면 반려동물 1마리당 월평균 양육비는 약 **12만 1천 원**으로 조사됐습니다. 동물별로는 강아지가 약 **13만 5천 원**, 고양이가 약 **9만 2천 원**이었으며, 전체 평균 병원비는 월 약 **3만 7천 원**이었습니다.
        </p>
        <p>
        ...
        <p>
          이 계산기는 예비 보호자와 현재 반려인이 막연하게 느낄 수 있는 **'반려동물 양육비'를 항목별로 살펴보기 위한 참고 도구**입니다. 사료와 간식 등의 식비, 배변용품이나 고양이 모래 등 위생용품비, 미용 및 관리비, 예방접종과 건강검진 등의 의료비를 입력해 월 예상 지출과 장기간의 누적 예상 비용을 계산할 수 있습니다.
        </p>
        <p>
        ...
        <p>
          **퍼피·키튼 등 성장기**에는 필요한 예방접종과 기생충 예방, 건강검진 등이 집중될 수 있으며, 보호자의 선택과 수의학적 판단에 따라 중성화수술 등의 일회성 비용이 발생할 수도 있습니다. 하네스, 이동장, 화장실, 식기, 침구와 같은 기본 생활용품을 처음 마련하는 비용도 고려해야 합니다.
        </p>
        <p>
          **성년기**에는 사료와 간식, 배변용품이나 고양이 모래, 예방관리 등 비교적 반복적인 생활비의 비중이 커집니다. 다만 피부질환, 치과질환, 외상이나 기타 질병이 발생하면 평소보다 의료비가 증가할 수 있습니다.
        </p>
        <p>
          **시니어 시기**가 되면 건강 상태를 더 자주 확인해야 할 필요성이 커지고, 일부 반려동물에서는 만성 신장질환, 관절질환, 심혈관계 질환, 치과질환, 종양 등 다양한 건강 문제가 발생할 가능성이 높아질 수 있습니다. 이에 따라 검사, 약물, 처방식, 치료 등에 드는 비용이 이전보다 증가할 수도 있습니다.
        </p>
        <p>
        ...
        <p>
          따라서 평소 생활비뿐 아니라 **예기치 않은 의료비에 대비할 수 있는 별도의 예산을 마련해 두는 것**도 고려할 만합니다. 일정 금액을 반려동물 의료비 용도로 따로 저축하거나, 보장 범위와 자기부담금, 보장 제외 항목 등을 비교한 뒤 펫보험 가입을 검토하는 방법도 있습니다.
        </p>
        <p>
          어떤 방법을 선택하든 중요한 것은 반려동물을 맞이하기 전에 **현재의 월 양육비뿐 아니라 앞으로 발생할 수 있는 장기적인 비용까지 함께 생각해 보는 것**입니다.
        </p>
