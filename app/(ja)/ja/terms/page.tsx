          ...
          <div className="prose prose-magenta max-w-none text-gray-600 leading-relaxed font-sans">
            ...
            <div className="mb-6">
              ...
              <ul className="list-disc pl-5 mt-2 space-y-1">
                <li>本ウェブサイトで提供されるすべてのコンテンツ、数値、計算結果は、獣医学的な診断、治療、処方を代行するものではありません。</li>
                <li>伴侶動物の健康に異常の兆候がある場合、または病気が疑われる場合は、必ず専門の獣医師の診察と相談を受けてください。</li>
                <li>利用者が本ウェブサイトの情報を基に行った行動について、研究所はいかなる法的責任も負いません。</li>
              </ul>
            </div>
            ...
            <p className="mb-6">
              ...
              <br />3. 運営者は、利用者がウェブサイトの情報、資料、事実の信頼度や正確性を盲信したことによって発生した損害について責任を負いません。
            </p>
