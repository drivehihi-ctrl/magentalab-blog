        ...
        <div className="bg-white rounded-3xl border border-gray-100 p-8 md:p-12 shadow-sm">
          <div className="prose prose-magenta max-w-none text-gray-600 leading-relaxed font-sans">
            ...
            <p className="mb-6">
              ...
              <br />- ソーシャルログイン（OAuth 2.0）利用時に収集する項目：
              <ul className="list-disc pl-5 mt-2 space-y-1">
                <li>ログイン方式：Google、Kakaoの簡単ログイン</li>
                <li>収集フィールド：ソーシャルアカウントの名前、メールアドレス、プロフィール画像</li>
                <li>アカウントおよび情報の削除方法：メール（smagentalab@gmail.com）による退会要請時に遅滞なく破棄</li>
              </ul>
