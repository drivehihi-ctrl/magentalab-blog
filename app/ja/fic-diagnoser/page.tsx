  ...
  return (
    <div className="bg-slate-50 pb-20">
      ...
      <SeoArticle title="猫に多い下部尿路疾患、特発性膀胱炎（FIC）とは？">
        <p>
          猫下部尿路疾患（FLUTD, Feline Lower Urinary Tract Disease）は、ひとつの特定の病気を指すのではなく、膀胱や尿道に起こるさまざまな疾患をまとめた呼び方です。その中でも<strong></strong>は特に多く診断される原因のひとつで、複数の研究ではFLUTDの症状を示す猫のおよそ55～65％前後を占めると報告されています。
        </p>
        <p>
          「特発性（Idiopathic）」とは、結石、細菌感染、腫瘍など、症状を説明できる明確な原因が特定できないことを意味します。そのためFICは、尿検査や画像検査などによって他の原因を除外したうえで診断されることが多い疾患です。
        </p>
        <p>
          FICの正確な原因は、現在もひとつには特定されていません。現在の獣医学では、<strong></strong>と考えられています。
        </p>
        <p>
          猫は生活環境の変化や社会的な緊張に敏感なことがあります。引っ越し、新しい家族やペットが加わること、ほかの猫との関係の変化、生活リズムの変化、トイレ環境の変更などは、一部の猫にとってストレス要因になる可能性があります。
        </p>
        <p>
          ただし、単純に「ストレスを受けると膀胱炎になる」という意味ではありません。すべてのストレスがFICを引き起こすわけではなく、ストレスへの反応や発症リスクには個体差があります。FICを繰り返す猫では、生活環境を安定させ、ストレス要因を減らすための<strong></strong>が管理の重要な要素になることがあります。
        </p>
        ...
        <p>
          オス猫はメス猫に比べて尿道が長く細いため、<strong></strong>のリスクが高くなります。FICによる炎症や尿道のけいれん、尿道栓、結石などが尿道を塞ぐと、尿を正常に排出できなくなることがあります。
        </p>
        <p>
          猫が何度もトイレに入り、排尿姿勢を取って力んでいるにもかかわらず、<strong></strong>
        </p>
        <p>
          完全な尿道閉塞が続くと、腎機能に重大な影響を与え、血中カリウム濃度の上昇、酸塩基平衡異常、尿毒症など、生命を脅かす合併症につながる可能性があります。そのため、特にオス猫が繰り返し排尿姿勢を取るものの実際に尿が出ていない場合は、<strong></strong>
        </p>
        <p>
