...
export default function CalculatorBanner({ content, title }: CalculatorBannerProps) {
  ...
  const scores = {
    emergency: getScore([
      "초콜릿", "다크", "밀크초콜릿", "포도", "건포도", "자일리톨", "독성", "독", 
      "치사량", "응급", "병원", "위험", "음독", "먹으면 안되는", "피해야 할", "치명",
      "양파", "파", "마늘", "응급실", "삼켰", "먹었", "초콜렛"
    ]),
    dm: getScore([
      "물", "음수량", "식수", "탈수", "신장", "단백질", "지방", "조단백", 
      "조지방", "수분", "건물", "dm", "등록성분", "성분표", "음수", "급여량",
      "음수 요구량", "건조", "사료 성분", "탄수화물", "회분"
    ]),
    bcs: getScore([
      "비만", "과체중", "다이어트", "체중", "살", "뚱뚱", "bcs", "칼로리", 
      "rer", "der", "급여량", "사료량", "감량", "몸무게", "뚱냥", "뚱견",
      "이상적 체중", "가이드량", "식사량", "칼로리 계산"
    ]),
    age: getScore([
      "나이", "생애", "주기", "개월", "사람 나이", "인간 나이", "성장기", 
      "노령", "성숙", "아깽이", "퍼피", "시니어", "수명", "노화", "어린", "노령묘",
      "노령견", "태어난", "연월", "개월수", "생애주기"
    ])
  };
