...
export default function FicDiagnoser({ lang = "ko" }: FicDiagnoserProps) {
  ...
  const dict = {
    ko: {
      ...
      cautionDesc: "본 체크리스트 도구는 국제 고양이의학협회(ISFM) 및 미국의 고양이 임상진료 가이드라인을 근거로 제작되었습니다. 단, 방광염은 요로 결석, 세균성 감염 등 다른 신장 비뇨기계 질환과 증상이 유사하므로, 소변을 전혀 보지 못하거나 혈뇨를 누는 응급 징후 발견 시 즉시 병원 검사를 권장합니다.",
    },
    en: {
      badge: "Ansim-i's Stress Note",
