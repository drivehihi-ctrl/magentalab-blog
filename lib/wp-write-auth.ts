...
export function getWordPressWriteConfig(): WordPressWriteConfig {
  ...
  if (!baseUrl || !username || !appPassword) {
    throw new Error('WORDPRESS_WRITE_CONFIG_MISSING: WORDPRESS_API_URL/NEXT_PUBLIC_WORDPRESS_URL, WORDPRESS_API_USERNAME, and WORDPRESS_API_APP_PASSWORD are required.');
  }
